...
const PrivacyBadge = memo(function PrivacyBadge({ hashed, hashValue, onClick, variant = 'home' }: PrivacyBadgeProps) {
    ...
    >
      ...
      <span>
        {hashed && hashValue
          ...
          : hashed ? 'encrypted on device + proxied anonymously' : 'Privacy Protected'}
      </span>
    </button>
  )
})
